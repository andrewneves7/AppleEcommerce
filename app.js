...
const slideshow =() =>{
    setInterval(()=>{
        ...
        //console.log('this is current div')
        //console.log(div)
        ...
        // console.log('this is the next div')
...
const watchTopControl = document.querySelector('.watch-top-controls')
const watchRightControl = document.querySelector('.watch-right-controls')
const watchBottomControl = document.querySelector('.watch-bottom-controls')
const watchLeftControl = document.querySelector('.watch-left-controls')
